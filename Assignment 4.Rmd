...
iso2 and iso3 are redundant with country because while country contains the full name of the country (i.e. Afghanistan) iso2 contains the 2 letter abbreviation (AF) and iso3 contains the three letter abbreviation (AFG).
